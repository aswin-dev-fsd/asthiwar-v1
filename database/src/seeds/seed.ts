...
async function seedPackages() {
  ...
  await db.insert(packagePrices).values(prices).onConflictDoNothing();
...
async function seedSpecifications(
  ...
  const itemDefs: {
    ...
    { slug: 'pvc_cpvc_pipes',     catSlug: 'kitchen', name: 'PVC & CPVC Pipes',          unit: 'sqft', isCustomizable: true,  sortOrder: 4 },
    // Bathroom
    { slug: 'bathroom_wall_tiles', catSlug: 'bathroom', name: 'Bathroom Wall Tiles',     unit: 'sqft', isCustomizable: false, sortOrder: 1 },
    { slug: 'sanitary_fittings',   catSlug: 'bathroom', name: 'Sanitary & CP Fittings',  unit: 'fixed',isCustomizable: true,  sortOrder: 2 },
    // Flooring
    { slug: 'main_flooring',       catSlug: 'flooring', name: 'Main Flooring',           unit: 'sqft', isCustomizable: false, sortOrder: 1 },
    { slug: 'balcony_flooring',    catSlug: 'flooring', name: 'Balcony & Open Area',     unit: 'sqft', isCustomizable: false, sortOrder: 2 },
  ...
  await db.insert(items).values(itemInserts).onConflictDoNothing();
  log('Items', itemInserts.length);
  ...
  const optionDefs: {
    ...
    // Masonry Work
    { itemSlug: 'masonry_work', slug: 'solid_block',      brandName: 'Solid Blocks',                isDefault: true  },
    { itemSlug: 'masonry_work', slug: 'flyash_aac',       brandName: 'Fly Ash / AAC Blocks',        isDefault: false },
    { itemSlug: 'masonry_work', slug: 'red_brick',        brandName: 'Red Bricks',                  isDefault: false },
    // Waterproofing
    { itemSlug: 'waterproofing', slug: 'dr_fixit',        brandName: 'Dr. Fixit',                   isDefault: true  },
    { itemSlug: 'waterproofing', slug: 'fosroc',          brandName: 'Fosroc',                      isDefault: false },
    { itemSlug: 'waterproofing', slug: 'bostik',          brandName: 'Bostik',                      isDefault: false },
    // Basement
    { itemSlug: 'basement_pcc', slug: 'pcc_basement',     brandName: 'PCC (Standard)',               isDefault: true  },
    { itemSlug: 'basement_pcc', slug: 'rcc_basement',     brandName: 'RCC Basement',                isDefault: false },
    // Sanitary Fittings
    { itemSlug: 'sanitary_fittings', slug: 'any_isi_sanitary',  brandName: 'Any ISI Brand',         isDefault: true  },
    { itemSlug: 'sanitary_fittings', slug: 'parryware',         brandName: 'Parryware',             isDefault: false },
    { itemSlug: 'sanitary_fittings', slug: 'jaquar',            brandName: 'Jaquar',                isDefault: false },
    { itemSlug: 'sanitary_fittings', slug: 'toto_kohler',       brandName: 'Toto / Kohler',         isDefault: false },
    // PVC/CPVC Pipes
    { itemSlug: 'pvc_cpvc_pipes', slug: 'any_isi_pipe',         brandName: 'Any ISI Brand',         isDefault: true  },
    { itemSlug: 'pvc_cpvc_pipes', slug: 'watertec',             brandName: 'Watertec',              isDefault: false },
    { itemSlug: 'pvc_cpvc_pipes', slug: 'kavery_ashirwad',      brandName: 'Kavery / Ashirwad',     isDefault: false },
    { itemSlug: 'pvc_cpvc_pipes', slug: 'finolex_supreme',      brandName: 'Finolex / Supreme',     isDefault: false },
    // Interior Painting
    { itemSlug: 'interior_painting', slug: 'isi_emulsion',       brandName: '1 Putty + 2 ISI Emulsion',           isDefault: true  },
    { itemSlug: 'interior_painting', slug: 'asian_tractor',      brandName: '2 JSW Putty + 2 Asian Tractor',     isDefault: false },
    { itemSlug: 'interior_painting', slug: 'asian_premium',      brandName: '2 Asian/Birla Putty + 2 Asian Premium', isDefault: false },
    { itemSlug: 'interior_painting', slug: 'asian_royale',       brandName: '3 Asian/Birla Putty + 2 Asian Royale', isDefault: false },
    // Exterior Painting
    { itemSlug: 'exterior_painting', slug: 'isi_exterior',       brandName: '1 Primer + 2 ISI Emulsion',         isDefault: true  },
    { itemSlug: 'exterior_painting', slug: 'asian_ace',          brandName: '1 Asian Primer + 2 Asian Ace',      isDefault: false },
    { itemSlug: 'exterior_painting', slug: 'asian_apex',         brandName: '1 Asian Primer + 2 Asian Apex',     isDefault: false },
    { itemSlug: 'exterior_painting', slug: 'ultima_protek',      brandName: '1 Waterproof Primer + 2 Ultima Protek', isDefault: false },
    // Wires & Switches
    { itemSlug: 'wires_switches', slug: 'isi_switches',          brandName: 'ISI / ISI',                         isDefault: true  },
    { itemSlug: 'wires_switches', slug: 'rr_anchor_roma',        brandName: 'RR/Orbit & Anchor Roma',            isDefault: false },
    { itemSlug: 'wires_switches', slug: 'finolex_legrand',       brandName: 'Finolex & Legrand/GM',              isDefault: false },
    // Lights
    { itemSlug: 'lights', slug: 'any_isi_lights',                brandName: 'Any ISI Brand',                     isDefault: true  },
  ...
  const optionInserts = optionDefs.map((o) => ({
    itemId: itemIdBySlug[o.itemSlug],
    slug: o.slug,
